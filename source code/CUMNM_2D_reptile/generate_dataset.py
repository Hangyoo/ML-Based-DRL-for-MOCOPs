...
if __name__ == "__main__":
    # TSP
    # file_path = 'MOTSP_training_data.txt'
    # # 创建张量
    # tensor = torch.rand(size=(20000000, 50, 4))
    # # 转换为 NumPy 数组
    ...
    # KP
    # file_path = 'MOKP_training_data.txt'
    # batch_size = 20000000
    # kp_problems = get_random_problems_mixed(batch_size=batch_size, problem_size=50, problem_type='KP')
    ...
    # CVRP
    file_path = 'MOCVRP_training_data.txt'
    batch_size = 20 #20000000
    problem_size = 50
    if problem_size == 20:
        demand_scaler = 30
    elif problem_size == 50:
    ...
    # VRPTW
    # file_path = 'MOVRPTW_training_data.txt'
    # batch_size = 30
    # depot_xy, node_xy, node_demand, node_serviceTime, node_earlyTW, node_lateTW = get_random_problems_mixed(batch_size=batch_size, problem_size=50, problem_type='VRPTW')
