...
class VRPTester:
    def __init__(self,
        ...
        print('Total Params Num :', total_params)  # 2189864 MOTSP 2189864
    ...
    def run(self, pref):
        ...
        while episode < test_num_episode:
            ...
            aug_score = self._test_one_batch(pref, batch_size, episode)
    ...
    def _test_one_batch(self, pref, batch_size, episode):
        ...
        with torch.no_grad():
            ...
            if self.env.attribute_c:
            ...
            elif self.env.attribute_ovrp:
                self.model.decoder_OVRP.assign(pref)
                ...
                self.model.decoder_MIXTSP.assign(pref)
            else:
