...
class TSPTrainer:
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            # Train
            train_score_obj1, train_score_obj2, train_score_obj3, train_score_obj4, train_score_obj5, train_loss = self._train_one_epoch(epoch)
    ...
    def _train_one_epoch(self, epoch):
        ...
        while episode < train_num_episode:
            ...
            avg_score_obj1, avg_score_obj2, avg_score_obj3,avg_score_obj4, avg_score_obj5, avg_loss = self._train_one_batch(batch_size)
            ...
            if epoch == self.start_epoch:
                loop_cnt += 1
                if loop_cnt <= 10:
                    self.logger.info('Epoch {:3d}: Train {:3d}/{:3d}({:1.1f}%)  Obj1 Score: {:.4f}, Obj2 Score: {:.4f}, Obj3 Score: {:.4f}, Loss: {:.4f}, Obj4 Score: {:.4f}, Obj5 Score: {:.4f}, Loss: {:.4f}'
                                     .format(epoch, episode, train_num_episode, 100. * episode / train_num_episode,
                                             score_AM_obj1.avg, score_AM_obj2.avg, score_AM_obj3.avg, score_AM_obj4.avg, score_AM_obj5.avg, loss_AM.avg))

        # Log Once, for each epoch
        self.logger.info('Epoch {:3d}: Train ({:3.0f}%)  Obj1 Score: {:.4f}, Obj2 Score: {:.4f},  Obj3 Score: {:.4f}, Loss: {:.4f}, Obj4 Score: {:.4f},  Obj5 Score: {:.4f}, Loss: {:.4f}'
                         .format(epoch, 100. * episode / train_num_episode,
                                 score_AM_obj1.avg, score_AM_obj2.avg, score_AM_obj3.avg,score_AM_obj4.avg, score_AM_obj5.avg,  loss_AM.avg))

        return score_AM_obj1.avg, score_AM_obj2.avg, score_AM_obj3.avg, score_AM_obj4.avg, score_AM_obj5.avg, loss_AM.avg
    ...
    def _train_one_batch(self, batch_size):
        ...
        return score_mean_obj1.item(), score_mean_obj2.item(), score_mean_obj3.item(), score_mean_obj4.item(), score_mean_obj5.item(), loss_mean.item()