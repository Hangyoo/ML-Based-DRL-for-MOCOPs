...
sol_file = rf"C:\Users\Hangyu\Desktop\CVRP\F\F-n135-k7.sol"
sol_file_list.append(sol_file)
# insname.append(ins.split('.')[0])

vrp_file = rf"C:\Users\Hangyu\Desktop\CVRP\F\F-n135-k7.vrp"
...
for i in range(len(sol_file_list)):
    ...
    f = r'D:\informs\EMNH\Meta_Transformer_2D_single\POMO_MOCVRP\result\tch_aug\cvrp_real\A\A-n46-k7_POMO_CVRP.txt'
    ...
    save_path = rf"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\MOCVRP\F\F-n135-k7.txt"
