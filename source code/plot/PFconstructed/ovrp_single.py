...
sol_file = r"C:\Users\Hangyu\Desktop\OVRP\C1-C8\CMT8.sol"
sol_file_list.append(sol_file)
# insname.append(ins.split('.')[0])

vrp_file = rf"C:\Users\Hangyu\Desktop\OVRP\C1-C8\CMT8.vrp"
...
for i in range(len(sol_file_list)):
    ...
    # total_length_min = 838.44#(1+gap) * total_length
    # max_length_max = 138.79#(1-gap) * max_length
    ...
    f = r'D:\informs\EMNH\Meta_Transformer_2D_single\POMO_MOCVRP\result\tch_aug\cvrp_real\E\E-n101-k8_POMO_CVRP.txt'
    ...
    save_path = rf"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\MOOVRP\C1-C8\CMTI8.txt"
