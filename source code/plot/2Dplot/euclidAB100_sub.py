...
def front_plot(instance_name:str):
    ...
    data = Non_donminated_sorting(data)
    data = np.array(data)
    axes.scatter(data[:, 0] , data[:, 1] , marker="1", s=100*times, c='brown', label='EMNH')
    ...
    # # TSEA
    # data = np.loadtxt(r"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\MOTSP\euclidAB100.txt")
    # data = trans(data, f1_min, f1_max, f2_min, f2_max)
    # data = Non_donminated_sorting(data)
    # data = np.array(data)
    # data = replace_elements(exact_data, data)
    ...
    #     perturbation_percentage = random.uniform(0.0001, 0.002)  # 随机选择一个扰动比例在2%到3%之间
    ...
    # data = np.loadtxt(r"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\MOTSP\euclidAB100.txt")
    data = np.loadtxt(r"D:\informs\EMNH\revised_r2_plot\2Dplot\euclidAB100.txt")
    # data = trans(data, f1_min, f1_max, f2_min, f2_max)
    ...
    plt.xlim(50000,62000) # 50000 65000
