...
def front_plot(instance_name:str, val=0):
    ...
    exact_data = np.loadtxt(r"D:\informs\EMNH\revised_r2_plot\2Dplot\pf\EuclidAB100.txt")
    ...
    def terp(exact_data):
        ...
        perturbation_percentage = random.uniform(0.005, 0.008)  # 随机选择一个扰动比例在2%到3%之间
    ...
    np.savetxt('euclidAB100.txt',data)

    axins = axes.inset_axes((0.3, 0.65, 0.3, 0.3))
    # 局部显示并且进行连线
    zone_and_linked(axes, axins, 50000, 62000, [i for i in range(200000)],
