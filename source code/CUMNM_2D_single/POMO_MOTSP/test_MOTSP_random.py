...
# epoch = 2000
for instance_name in [f for f in os.listdir(r'C:\Users\Hangyu\Desktop\GitHub\Test Data\Random Test Set\MOTSP')]:
    ...
    env_params = {
        ...
        'instance_type': instance_name, #'KroAB'
        'instance_name': None
    }
    ...
    def main(n_sols = 101,idx=None):
        ...
        np.savetxt(fr"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\Random Test Set\MOTSP\{instance_name}", sols)
