...
reference_front_path = r"D:\informs\EMNH\Meta_Transformer_2D_single\POMO_MOCVRP\result\tch_noaug\cvrp_real\E\E100_epoch_2000.txt"
PF = np.loadtxt(reference_front_path)

HVs = []
# for epoch in range(10,2010,10):
for epoch in range(10,2010,10):
    reference_front_path_ga_1 = rf"D:\informs\EMNH\Meta_Transformer_2D_single\POMO_MOCVRP\result\tch_noaug\cvrp_real\E\E100_epoch_{epoch}.txt"
