...
for instance_name in [f for f in os.listdir(r'C:\Users\Hangyu\Desktop\GitHub\Test Data\Random Test Set\MOCVRP')]:
    print(f'当前执行{instance_name}')
    problem_size = int(instance_name.split('_')[1])
    ...
    def main(n_sols = 101,idx=None):
        ...
        np.savetxt(fr"C:\Users\Hangyu\Desktop\GitHub\Experimental Results\Random Test Set\MOCVRP\{instance_name}", sols)
