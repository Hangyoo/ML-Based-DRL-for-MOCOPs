...
import logging
from Meta_Transformer_2D_single.utils.utils import create_logger, copy_all_src

from VRPTrainer_reptile import VRPTrainer as Trainer
...
env_params = {
    'problem_type': 'MOMIXTSP',
    'problem_size': 50,
    'pomo_size': 50,
    'aggregate_function': 'TCH',  # 'TCH' 'Weighted'  'PBI'
    'distributed': False, # 多GPU并行计算
    'benchmark_instance': False, # 不读取benchmark
    'instance_type': None,
    'instance_name': None
}
...
trainer_params = {
    ...
    'logging': {
        ...
        'log_image_params_f1': {
            ...
            'filename': 'style_unified_50.json'
        },
        'log_image_params_f2': {
            'json_foldername': 'log_image_style',
            'filename': 'style_unified_50.json'
